...
async def iva(interaction: discord.Interaction, prompt: str, file: discord.Attachment=None):
    ...
    try:
        ...
        IVA'S RESPONSE:
        You must ask yourself, `Thought: Do I need to use a tool? [Yes/No]` every time! When you are done using tools, You must prefix `Iva: ` before the final response you will send to the user! Do not forget these things! Now, start responding below.
        --------------------
        {{agent_scratchpad}}
        """
