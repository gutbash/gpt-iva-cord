...
async def iva(interaction: discord.Interaction, prompt: str, file: discord.Attachment = None):
    ...
    try:
        ...
        - Use DOT code to make digraphs to visualize and explain concepts in a stylish and aesthetically pleasing way with bgcolor=\"#36393f\" and complementary text colors and node fill colors.
