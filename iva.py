...
async def iva(interaction: discord.Interaction, prompt: str, file: discord.Attachment=None):
    ...
    try:
        ...
        IVA'S RESPONSE:
        You must cite any URL sources utilized from Organic Results! When you are done using tools, You must prefix the cited final response you will send to the user with `Iva: ` or else the user won't see it! Do not forget these things! Now, start responding below...
        --------------------
        {{agent_scratchpad}}
        """
